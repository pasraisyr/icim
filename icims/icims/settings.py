...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-jb3*(langvf4h@hg)h(b)8vdvk32r2q0-r1n#m_-g837^lpd7o')
...
# Custom User Model
AUTH_USER_MODEL = 'icims_backend.CustomUser'
