    ...
    <DialogContent>
     ...
     <TextField
      ...
      >
        ...
        <MenuItem value="Tahap Rendah">Tahap Rendah</MenuItem>
        <MenuItem value="Tahap Menengah">Tahap Menengah</MenuItem>
        <MenuItem value="Kelas Tuisyen">Kelas Tuisyen</MenuItem>
